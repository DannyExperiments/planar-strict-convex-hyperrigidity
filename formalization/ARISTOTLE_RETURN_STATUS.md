...
- faithful exact-scope statements in
...
| Main planar POVM/PVM theorem | Unformalized (`sorry`) |
| Tuple compression corollary | Unformalized (`sorry`) |
| Square compression corollary | Unformalized (`sorry`) |
