...
| Main planar theorem | Arbitrary compact convex \(K\), affine dimension at most two | Artifacts A and B; Scherer's planar extreme-boundary theorem | **PASS in first hostile paper audit after specified repairs; repaired-manuscript re-audit and human specialist review pending** |
| Operator compression corollary | Commuting self-adjoint tuple with joint spectrum in such \(K\) | Main planar theorem and leakage identity | **PASS in first hostile paper audit; repaired-manuscript re-audit pending** |
