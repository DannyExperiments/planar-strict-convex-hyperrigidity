...
| Release signoff | Exact current TeX plus self-contained v4 evidence bundle | Six-category external audit | **v3 failed only four stale Scherer publication-status descriptions; repaired in v4; fresh signoff pending** |
