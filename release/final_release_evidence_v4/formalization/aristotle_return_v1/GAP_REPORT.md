...
├─ Theorem 3.4  Scherer's planar extreme-boundary rigidity      [EXTERNAL, JFA record]
...
* **Scherer's planar extreme-boundary rigidity theorem** (used as Theorem 3.4)
  first appeared as arXiv:2411.11709 in 2024 and now has a *Journal of
  Functional Analysis* publication record, volume 291, issue 10, article
  111602, DOI 10.1016/j.jfa.2026.111602, with assigned cover date
  15 November 2026. The manuscript cites the arXiv version. Formalizing the
  theorem is itself a major project; the manuscript uses it as a black box.
