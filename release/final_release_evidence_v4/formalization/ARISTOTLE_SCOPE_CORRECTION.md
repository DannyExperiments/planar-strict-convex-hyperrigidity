...
The extracted tree also contains a documentary-only correction to three
current files that had continued to call Scherer's planar theorem
“unpublished”:
...
The theorem first appeared as arXiv:2411.11709 in 2024. As checked against
Elsevier's article API on 2026-07-24, it now has a *Journal of Functional
Analysis* publication record, volume 291, issue 10, article 111602, DOI
10.1016/j.jfa.2026.111602, with assigned cover date 15 November 2026. The
manuscript may continue to cite the arXiv version. The original archive and
all comment-stripped Lean code remain unchanged.
