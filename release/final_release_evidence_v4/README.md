...
> v3 and covered by regression checks. The v3 final-corrective audit then
> passed mathematics, provenance, reproducibility, the formalization boundary,
> and public-claim scope, but failed literature consistency because four
> current extracted-tree statements still called Scherer's theorem
> “unpublished.” Those statements are corrected in v4 against the live JFA
> publication record and protected by a regression check. Fresh v4 release
> signoff is pending. Specialist human
