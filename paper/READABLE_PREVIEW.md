...
> Source SHA-256: `0653abf8b1fce768cfa9e84b58471a21e0bccad5744832474e1eaf6beb3e94b0`
...
In particular, this answers affirmatively the recorded two-variable equality
question for compressed convex functional calculus.
...
### Motivating question.
The CUHK-Shenzhen AI Math Problems database attributes its Problem 2,
``Equality case for compressed convex functional calculus,'' to Boris Bilich
and records that it was added on June 1, 2026 [CUHKProblem2].
In intrinsic compression notation, let \(X,Y\) be commuting positive
contractions, let \(P\) be an orthogonal projection, and put

$$
H=\operatorname{ran} P,\qquad A=PXP|_H,\qquad B=PYP|_H.
$$

If \(A\) and \(B\) commute, does the identity

$$
P f(X,Y)P|_H=f(A,B)
$$

for one continuous strictly convex \(f\colon[0,1]^2\to\mathbb R\) force
\(PX=XP\) and \(PY=YP\)?  Corollary `cor:square` answers this question
affirmatively.  The following theorem proves a stronger planar POVM/PVM
uniqueness statement from which that answer follows.
...
[https://github.com/DannyExperiments/planar-strict-convex-hyperrigidity](https://github.com/DannyExperiments/planar-strict-convex-hyperrigidity).
...
*Problem 2: Equality case for compressed convex functional calculus*,
source attributed to B. Bilich, added June 1, 2026,
[https://rybindmitry.github.io/problems/2.html](https://rybindmitry.github.io/problems/2.html)
